...
var
  newstockrecord: Tnewstockrecord;

implementation

{ Tnewstockrecord }

procedure Tnewstockrecord.ZTable1BeforePost(DataSet: TDataSet);
begin
...
procedure Tnewstockrecord.Edit1Click(Sender: TObject);
begin
  Edit1.Text:='';
end;

procedure Tnewstockrecord.BitBtn1Click(Sender: TObject);
begin
  self.free;
end;

procedure Tnewstockrecord.Edit1KeyPress(Sender: TObject; var Key: char);
begin
...
procedure Tnewstockrecord.FormShow(Sender: TObject);
begin
